    ...
    <div class="grid">
        <div class="col-12">
            <div class="card docs">
                ...
                <p>
                    Goal is an application template for Vue based on the <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue
                ...
                <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i> to view the application. That is it, you may now start with the development of your application using the Goal template.</p>

                <CodeHighlight> npm run dev </CodeHighlight>

                <h5>Structure</h5>
                <p>Goal consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application.</p>
                ...
                <p>Goal theming is based on the PrimeVue theme being used. Default theme is <b>lara-light-indigo</b>.</p>
